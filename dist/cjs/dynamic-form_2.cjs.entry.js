...
const DynamicForm = class {
  ...
  async componentWillLoad() {
    await loadScript.loadCss('https://cdn.jsdelivr.net/npm/bulma@0.9.3/css/bulma.min.css');
  ...
  renderField(element) {
    ...
    return (index.h(Tag, { value: this.model[element.key], templateOptions: element.templateOptions, onCustomChange: ev => {
        var _a, _b;
    ...
    return elements.map(element => {
      ...
      if (isHide == false) {
        if (element.type == 'line') {
          return [
            index.h("div", { class: "df-fields-container" }, element.fields.map(element => {
              var _a;
              return (index.h("div", { class: (element.type != 'html' ? (_a = this.options) === null || _a === void 0 ? void 0 : _a.fieldClass : '') + ' is-flex-grow-' + (element.size || 1) + ' ' + (element.className || '') }, this.renderField(element)));
            })),
            index.h("hr", { style: { 'text-align': 'left' } }),
          ];
        }
        else {
          return [
            index.h("div", { class: element.type != 'html' ? (_a = this.options) === null || _a === void 0 ? void 0 : _a.fieldClass : '' }, this.renderField(element)),
            ((_b = this.options) === null || _b === void 0 ? void 0 : _b.separator) == true && element.type != 'html' ? index.h("hr", { style: { 'text-align': 'left' } }) : null,
          ];
        }
      }
    });
  ...
  render() {
    ...
    return index.h("div", null, ((_a = this.fields) === null || _a === void 0 ? void 0 : _a.length) ? this.renderFields(this.fields) : null);
  }
};
...
const Example1 = class {
  ...
  save() { }
  render() {
    return (index.h("div", { class: "m-4" }, index.h("dynamic-form", { model: this.model, fields: this.form, options: {

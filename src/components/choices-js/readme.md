...
| `valueByDefault`            | `value-by-default`         |             | `any`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | `undefined` |
...
| ---------------- | ----------- | ------------------ |
| `callbackChoice` |             | `CustomEvent<any>` |
...
### Used by
 ...
 - [field-select](../dynamic-form/fields)

### Graph
```mermaid
graph TD;
  field-select --> choices-js
  style choices-js fill:#f9f,stroke:#333,stroke-width:4px
```
